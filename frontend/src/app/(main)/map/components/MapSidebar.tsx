  ...
  return (
    <div
      className={`
        ...
        bg-[var(--box-map-bg-color)] backdrop-blur-[27.2px] px-6 py-6 overflow-y-auto 
        transform transition-transform duration-300
        w-full md:w-[360px] rounded-r-[20px] shadow-lg
          ...
          {loading ? (
            ...
            <>
              ...
              <Input
                ...
                value={localSearch}
                onChange={handleSearchChange}
                className="pl-12 pr-4 py-5 bg-white text-black placeholder:text-gray-400 rounded-full border-white focus:border-white focus:outline-none focus:ring-0 shadow-[0px_1px_1px_0px_#0000000D]"
              />
              {localSearch && (
                <button
                  onClick={() => {
